...
class Klinik extends CI_Controller
{
  ...
  function data_keluarga($nama=null, $tgl_lahir=null, $no_hp=null, $email=null){
    echo json_encode($this->Klinik_model->tampil($nama, $tgl_lahir, $no_hp, $email));
  }
  ...
  public function send_email()
  {
    ...
    $kode_verifikasi = random_string('numeric', 6);
    ...
    if ($this->email->send()) {
      ...
      $pasien = $this->Klinik_model->insert_pasien($data_pasien);
      ...
      $this->Klinik_model->insert_verifikasi($data_verifikasi);
    } else {
  ...
  public function add_booking()
  {
    ...
    if ($id_pasien == "" || $id_cabang == "" || $id_dokter == "") {
      ...
      redirect(base_url('klinik/data_booking/' . $id_pasien . '/' . $id_booking.'.html'));
    }
  }
  ...
  public function get_informasi_pasien(){
    echo json_encode($this->Informasi_pasien_model->get_informasi_pasien_all()->result());
    // $this->Informasi_pasien_model->get_informasi_pasien_all()->result();
  ...
  public function get_informasi_pasien2($nama2="", $tgl_lahir2="", $rekam_medis2=""){
    ...
    echo json_encode($this->Informasi_pasien_model->get_informasi_pasien_all2($nama, $tgl_lahir, $rekam_medis)->result());
  }
  ...
  function filter_profil()
  {
    ...
    $this->load->view('klinik/filter_profil', $data);
  }
  ...
  function filter_tanggal()
  {
    ...
    $this->load->view('klinik/filter_tanggal', $data);
  ...
  public function cek_kode($kode){
    $res = $this->Klinik_model->cekkode($kode)->row();
