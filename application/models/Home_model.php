...
class Home_model extends CI_Model
{
	...
	{
		$konf = '1';
		$this->db->select('a.id_booking ,d.nama_depan, d.nama_belakang, b.jam_rencana_mulai, b.jam_rencana_selesai, b.tanggal_rencana, d.tanggal_lahir, c.id_rekam_medis, a.status, d.id_pasien, e.nama_dokter');
		$this->db->from('booking a');
		$this->db->join('rencana b', 'a.id_booking=b.id_booking');
	...
	function get_data_pemeriksaan($id_dokter)
	{
		$konf = '1';
	...
	function get_data_pemeriksaan2($jam_rencana_mulai, $nama, $tgl_lahir, $rekam_medis, $status,  $kode_booking, $id_dokter)
	{
		$konf = '1';
