                ...
                <div class="panel-body">
                    <div class="btn-group list-group" data-toggle="buttons" style="margin-bottom: -9px;">
                        <div id="kariesSuperfisia_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 3px 0px;" onclick="zoom()">
                            <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option21" checked><img src="<?php echo base_url('assets/img/icon/panah.jpg') ?>" style="width: 24px;">
                        </div>
                        <p>
                            <div id="kariesSuperfisia2_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                                <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option2" checked><img src="<?php echo base_url('assets/img/icon/2.jpg') ?>" style="width: 28px;">
                            </div>
                        </p>
                        <div id="kariesSuperfisia3_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                            <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option3" checked> <img src="<?php echo base_url('assets/img/icon/3.jpg') ?>" style="width: 28px;">
                        </div>
                        <p>
                            <div id="kariesSuperfisia12_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                                <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" s name="options" id="option13" checked> <img src="<?php echo base_url('assets/img/icon/41.jpg') ?>" style="width: 31px;">
                            </div>
                        </p>
                        <div id="kariesSuperfisia13_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                            <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option14" checked> <img src="<?php echo base_url('assets/img/icon/42.jpg') ?>" style="width: 31px;">
                        </div>
                        <p>
                            <div id="kariesSuperfisia14_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                                <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option15" checked> <img src="<?php echo base_url('assets/img/icon/43.jpg') ?>" style="width: 31px;">
                            </div>
                        </p>
                        <div id="kariesSuperfisia4_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                            <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option4" checked><img src="<?php echo base_url('assets/img/icon/4.jpg') ?>" style="width: 28px;">
                        </div>
                        <p>
                            <div id="kariesSuperfisia5_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                                <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option5" checked><img src="<?php echo base_url('assets/img/icon/5.jpg') ?>" style="width: 28px;">
                            </div>
                        </p>
                        <div id="kariesSuperfisia6_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                            <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option7" checked><img src="<?php echo base_url('assets/img/icon/6.jpg') ?>" style="width: 28px;">
                        </div>
                        <p>
                            <div id="kariesSuperfisia7_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                                <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option8" checked><img src="<?php echo base_url('assets/img/icon/7.jpg') ?>" style="width: 28px;">
                            </div>
                        </p>
                        <div id="kariesSuperfisia8_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                            <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option9" checked><img src="<?php echo base_url('assets/img/icon/8.jpg') ?>" style="width: 28px;">
                        </div>
                        <p>
                            <div id="kariesSuperfisia9_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                                <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option10" checked><img src="<?php echo base_url('assets/img/icon/9.jpg') ?>" style="width: 28px;">
                            </div>
                        </p>
                        <div id="kariesSuperfisia10_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;" onclick="defaulton()">
                            <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option11" checked><img src="<?php echo base_url('assets/img/icon/10.jpg') ?>" style="width: 28px;">
                        </div>
                        <p>
                            <div id="kariesSuperfisia11_after" class="btn list-group-item" style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0;" onclick="defaulton()">
                                <input type="radio" style="position: fixed;opacity: 0;pointer-events: none;" name="options" id="option6" autocomplete="off"><img src="<?php echo base_url('assets/img/icon/11.jpg') ?>" style="width: 28px;">
                            </div>
                        </p>
                    </div>
                </div>
                ...
                <div id="svgselect" style="width: 610px; height: 230px; background-color: #ffffff;margin-left: 15px;margin-bottom: 385px;">
                    ...
                    <div class='col-sm-12'>
                        <div class="row">
                            ...
                            <div class='col-sm-4'>
                                <div id="controls2_after" class="panel panel-default" style="padding-bottom: 80px;">
                                    <div class="panel-body">
                                        <div class="btn-group list-group" data-toggle="buttons" style="margin-bottom: -9px;">
                                            <p style="margin-left: 17px;">
                                                <div id="sambung_after" class="btn list-group-item mb-5" style="width: 54%;color: black;background-color: white;border-color: white;padding: 5px 0;padding-bottom: 40px">
                                            ...
                                            <p style="margin-left: 17px;">
                                                <div id="porcelain_after" class="btn list-group-item mt-3" style="width: 54%;color: black;background-color: white;border-color: white;padding: 5px 0;">
