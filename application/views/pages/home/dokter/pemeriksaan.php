    ...
    <form action="">
        ...
        <div class="bs-stepper-content">
                    ...
                    <div class="mx-4">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="last-name" id="input-nama-belakang"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="jns-kelamin" id="jns-kelamin">
                                    <option value="Laki-laki"
                                        <?= strcasecmp("Laki-laki", $pasien['jenis_kelamin'])  == 0 ? 'selected' : '';?>>
                                        Laki-laki</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="status-pernikahan" id="status-pernikahan">
                                    ...
                                    <option value="Menikah"
                                        <?= $pasien['status_nikah'] == 'Menikah' ? 'selected' : '';?>>
                                        Menikah</option>
                                    <option value="Belum Menikah"
                                        <?= $pasien['status_nikah'] == 'Belum Menikah' ? 'selected' : '';?>>Belum
                                        Menikah
                                    </option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="pekerjaan" id="pekerjaan">
                                    ...
                                    <option value="Aparatur Sipil Negara"
                                        <?= $pasien['pekerjaan'] == 'Aparatur Sipil Negara' ? 'selected' : '';?>>
                                        Aparatur Sipil Negara
                                    </option>
                                    <option value="Pegawai BUMN"
                                        <?= $pasien['pekerjaan'] == 'Pegawai BUMN' ? 'selected' : '';?>>
                                        Pegawai BUMN
                                    </option>
                                    <option value="Pegawai Swasta"
                                        <?= $pasien['pekerjaan'] == 'Pegawai Swasta' ? 'selected' : '';?>>
                                        Pegawai Swasta
                                    </option>
                                    <option value="Wiraswasta"
                                        <?= $pasien['pekerjaan'] == 'Wiraswasta' ? 'selected' : '';?>>
                                        Wiraswasta
                                    </option>
                                    <option value="Tidak Bekerja"
                                        <?= $pasien['pekerjaan'] == 'Tidak Bekerja' ? 'selected' : '';?>>
                                        Tidak Bekerja
                                    </option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="pendidikan" id="pendidikan">
                                    ...
                                    <option value="SMA/setaranya"
                                        <?= $pasien['pendidikan'] == 'SMA/setaranya' ? 'selected' : '';?>>
                                        SMA/setaranya
                                    </option>
                                    <option value="S1/S2/S3"
                                        <?= $pasien['pendidikan'] == 'S1/S2/S3' ? 'selected' : '';?>>
                                        S1/S2/S3
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="alergi" id="alergi"
                                    value="<?= $pasien['alergi'];?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="rwyt-penyakit" id="rwyt-penyakit"
                                value="<?= $pasien['riwayat_penyakit'];?>" autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="">Kondisi Kesehatan Pasien</label> <br>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="baik" name="kondisi-kesehatan" class="custom-control-input"
                                    value="Baik">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="sedang" name="kondisi-kesehatan" class="custom-control-input"
                                    value="Sedang">
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="buruk" name="kondisi-kesehatan" class="custom-control-input"
                                    value="Buruk">
                            ...
                            <div class="col">
                                ...
                                <div id="ekstra-oral" class="ml-4">
                                    <fieldset class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="wajah1" name="wajah"
                                                    class="custom-control-input" value="Simetri">
                                                <label class="custom-control-label" for="wajah1">Simetri</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="wajah2" name="wajah"
                                                    class="custom-control-input" value="Asimetri">
                                    ...
                                    <fieldset class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="bibir1" name="bibir"
                                                    class="custom-control-input" onclick="disableInput('#bibir-lain')">
                                                <label class="custom-control-label" for="bibir1">Normal</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="bibir2" name="bibir"
                                                    class="custom-control-input" onclick="enableInput('#bibir-lain')">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <fieldset class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="kalkulus" name="kalkulus"
                                                class="custom-control-input" value="Normal">
                                            <label class="custom-control-label" for="kalkulus">Normal</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="kalkulus2" name="kalkulus"
                                                class="custom-control-input" value="Subgingiva">
                                            <label class="custom-control-label" for="kalkulus2">Subgingiva</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="kalkulus3" name="kalkulus"
                                                class="custom-control-input" value="Supragingiva">
                                ...
                                <fieldset class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="gingiva1" name="gingiva"
                                                class="custom-control-input" value="Normal"
                                                onclick="disableInput('#gingiva-lain')">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="debris" name="debris" class="custom-control-input"
                                                value="Normal" onclick="disableInput('#debris-lain')">
                                            ...
                                            <div class="row">
                                                <div class="col-5">
                                                    <input type="radio" id="debris2" name="debris"
                                                        class="custom-control-input"
                                                        onclick="enableInput('#debris-lain')">
                                                    <label class="custom-control-label" for="debris2">
                                                        Ada Kelainan
                                                    </label>
                                                </div>
                                                <div class="col">
                                                    <input class="form-control " type="text" name="debris"
                                                        id="debris-lain" placeholder="Kelainan Debris"
                                                        autocomplete="off" disabled>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="mukosa" name="mukosa" class="custom-control-input"
                                                value="Normal" onclick="disableInput('#mukosa-lain')">
                                            ...
                                            <div class="row">
                                                <div class="col-5">
                                                    <input type="radio" id="mukosa2" name="mukosa"
                                                        class="custom-control-input"
                                                        onclick="enableInput('#mukosa-lain')">
                                                    <label class="custom-control-label" for="mukosa2">Ada
                                                        Kelainan</label>
                                                </div>
                                                <div class="col">
                                                    <input class="form-control " type="text" name="mukosa"
                                                        id="mukosa-lain" placeholder="Kelainan Mukosa"
                                                        autocomplete="off" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="palatum" name="palatum" class="custom-control-input"
                                                value="Normal" onclick="disableInput('#palatum-lain')">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="lidah" name="lidah" class="custom-control-input"
                                                value="Normal" onclick="disableInput('#lidah-lain')">
                                            ...
                                            <div class="row">
                                                <div class="col-5">
                                                    <input type="radio" id="lidah2" name="lidah"
                                                        class="custom-control-input"
                                                        onclick="enableInput('#lidah-lain')">
                                                    <label class="custom-control-label" for="lidah2">Ada
                                                        Kelainan</label>
                                                </div>
                                                <div class="col">
                                                    <input class="form-control " type="text" name="lidah"
                                                        id="lidah-lain" placeholder="Kelainan Lidah" autocomplete="off"
                                                        disabled>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <fieldset class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="dsr-mulut" name="dsr-mulut"
                                                class="custom-control-input" value="Normal"
                                                onclick="disableInput('#dsr-mulut-lain')">
                                            ...
                                            <div class="row">
                                                <div class="col-5">
                                                    <input type="radio" id="dsr-mulut2" name="dsr-mulut"
                                                        class="custom-control-input"
                                                        onclick="enableInput('#dsr-mulut-lain')">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="gerigi" name="gerigi" class="custom-control-input"
                                                value="Normal" onclick="disableInput('#gerigi-lain')">
                                            ...
                                            <div class="row">
                                                <div class="col-5">
                                                    <input type="radio" id="gerigi2" name="gerigi"
                                                        class="custom-control-input"
                                                        onclick="enableInput('#gerigi-lain')">
                                                    <label class="custom-control-label" for="gerigi2">Ada
                                                        Kelainan</label>
                                                </div>
                                                <div class="col">
                                                    <input class="form-control " type="text" name="gerigi"
                                                        id="gerigi-lain" placeholder="Kelainan Gigi Gerigi"
                                                        autocomplete="off" disabled>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div id="perawatan-part" class="content" role="tabpanel" aria-labelledby="perawatan-part-trigger"
                    ...
                    <div class="mx-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <input type="text" name="jml-gigi" id="jml-gigi" class="form-control"
                ...
                <button type="button" class="btn btn-secondary" onclick="stepper.previous()">Back</button>
                <button type="button" class="btn btn-primary btn-hitung-bayar" onclick="stepper.next()"
                    disabled>Next</button>
            </div>

            <div id="odontogram-after-part" class="content" role="tabpanel"
                aria-labelledby="odontogram-after-part-trigger" style="margin: 0 -1%;">
                <div class="card">
                    <div class="mx-4">
