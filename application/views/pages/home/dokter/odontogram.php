        ...
        <tr>
                ...
                <div id="controls" class="panel panel-default" style="margin-bottom: 270px;">
                    <div class="panel-body">
                        <div class="btn-group list-group" data-toggle="buttons" style="margin-bottom: -9px;">
                            <div class="p">
                                <p>
                                <div id="kariesSuperfisia" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 3px 0px;"
                                    onclick="zoom()">
                                    <input type="radio" name="options" id="option21" checked>
                                    <img src="<?php echo base_url('assets/img/icon/panah.jpg') ?>" style="width: 24px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia2" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option2" checked><img
                                        src="<?php echo base_url('assets/img/icon/2.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>
                                <br />

                                <p>
                                <div id="kariesSuperfisia3" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option3" checked> <img
                                        src="<?php echo base_url('assets/img/icon/3.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia12" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option13" checked> <img
                                        src="<?php echo base_url('assets/img/icon/41.jpg') ?>" style="width: 31px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia13" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option14" checked> <img
                                        src="<?php echo base_url('assets/img/icon/42.jpg') ?>" style="width: 31px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia14" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option15" checked> <img
                                        src="<?php echo base_url('assets/img/icon/43.jpg') ?>" style="width: 31px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia4" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option4" checked><img
                                        src="<?php echo base_url('assets/img/icon/4.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia5" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option5" checked><img
                                        src="<?php echo base_url('assets/img/icon/5.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia6" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option7" checked><img
                                        src="<?php echo base_url('assets/img/icon/6.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia7" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option8" checked><img
                                        src="<?php echo base_url('assets/img/icon/7.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia8" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option9" checked><img
                                        src="<?php echo base_url('assets/img/icon/8.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia9" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option10" checked><img
                                        src="<?php echo base_url('assets/img/icon/9.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia10" class="btn list-group-item"
                                    style="width: 100%;color: black;background-color: white;border-color: white;padding: 5px 0px;"
                                    onclick="defaulton()">
                                    <input type="radio" name="options" id="option11" checked><img
                                        src="<?php echo base_url('assets/img/icon/10.jpg') ?>" style="width: 28px;">
                                </div>
                                </p>

                                <p>
                                <div id="kariesSuperfisia11" class="btn list-group-item"
                                    style="width: 54%;color: black;background-color: white;border-color: white;padding: 5px 0;">
                                    <input type="radio" name="options" id="option6" autocomplete="off"><img
                                        src="<?php echo base_url('assets/img/icon/11.jpg') ?>" style="width: 28px;"
                                        onclick="defaulton()">
                                </div>
                                </p>
                            </div>
            ...
            <td>
                <div id="odontogram_utama">
                    ...
                    <div id="svgselect"
                        style="width: 610px; height: 230px; background-color: #ffffff;margin-left: 15px;margin-bottom: 385px;">
                                        ...
                                        <div class="panel-body" style='padding: 4px;'>
                                            <div class="btn-group list-group" data-toggle="buttons"
                                                ...
                                                <table class="table table-bordered" style='margin-bottom: 13px;'>
                                                    <tr>
                                                        <th colspan='2'
                                                            style='font-size: 9px;color: #fff;background-color: #000;'>
                                                            Keadaan Gigi</th>
                                                        <th colspan='2'
                                                            style='font-size: 9px;color: #fff;background-color: #000;'>
                                                    ...
                                                    <tr>
                                                        <td style='font-size: 9px;'>
                                                            <div id="non" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0;">
                                                                <input type="radio" name="options" id="option14"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">non
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="att" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option15"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">att
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="gif" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option16"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">gif
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="pon" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option17"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">pon
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style='font-size: 9px;'>
                                                            <div id="une" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0;">
                                                                <input type="radio" name="options" id="option18"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">une
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="abr" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option19"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">abr
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="inl" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option20"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">inl
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="abu" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option21"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">abu
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style='font-size: 9px;'>
                                                            <div id="pre" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0;">
                                                                <input type="radio" name="options" id="option22"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">pre
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="cfr" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option23"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">cfr
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="onl" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option24"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">onl
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="prd" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option25"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">prd
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style='font-size: 9px;'>
                                                            <div id="imv" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0;">
                                                                <input type="radio" name="options" id="option26"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">imv
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="rrx" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option27"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">rrx
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="mpc" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option28"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">mpc
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="fld" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option29"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">fld
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style='font-size: 9px;'>
                                                            <div id="ano" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0;">
                                                                <input type="radio" name="options" id="option30"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">ano
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="miss" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option31"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">mis
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="gmc" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option32"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">gmc
                                                            </div>
                                                        </td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="acr" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option33"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">acr
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style='font-size: 9px;'>
                                                            <div id="dia" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option34"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">dia
                                                            </div>
                                                        </td>
                                                        <td></td>
                                                        <td style='font-size: 9px;'>
                                                            <div id="ipx" class="btn list-group-item"
                                                                style="width: 100%;color: black;background-color: white;border-color: white;padding: 0px 0px;">
                                                                <input type="radio" name="options" id="option35"
                                                                    style="position: fixed;opacity: 0;pointer-events: none;">ipx
                                                            </div>
                                                        </td>
                                                        <td></td>
                                                    </tr>
                                    ...
                                    <div id="controls2" class="panel panel-default" style="margin-bottom: 270px;">
                                        <div class="panel-body">
                                            <div class="btn-group list-group" data-toggle="buttons"
                                                ...
                                                <div id="sambung" class="btn list-group-item"
                                                    style="width: 54%;color: black;background-color: white;border-color: white;padding: 5px 0;">
                                                    <input type="radio" name="options" id="option12" autocomplete="off">
                                                    <p style="margin-left: 14px;">
                                                        <b>Full Metal Bridge</b>
                                                    </p>
                                                    <img src="<?php echo base_url('assets/img/icon/bridge1.jpg') ?>"
                                                        style="width: 100px;position: inherit;right: -19px;">
                                                </div>
                                                </p>
                                                <p style="margin-left: 17px;">
                                                <div id="porcelain" class="btn list-group-item"
                                                    style="width: 54%;color: black;background-color: white;border-color: white;padding: 5px 0;">
                                                    <input type="radio" name="options" id="option13" autocomplete="off">
                                                    <p style="margin-left: 14px;">
                                                        <b>Porcelain Bridge</b>
                                                    </p>
                                                    <img src="<?php echo base_url('assets/img/icon/bridge2.jpg') ?>"
                                                        style="width: 121px;position: inherit;right: -7px;">
                                                </div>
                                                </p>
                                            </div>
                                        </div>
