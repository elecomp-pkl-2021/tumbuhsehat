<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<form action="<?= base_url('jadwal-dokter/tambah')?>" method="POST" enctype="multipart/form-dataa">
				<div class="card-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control " id="jam_mulai" placeholder="Masukkan jam mulai"
							name="jam_mulai" value="<?= set_value('jam_mulai') ?>">
						<?php endif ?>
					</div>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control " id="jam_tutup" placeholder="Masukkan jam tutup"
							name="jam_tutup" value="<?= set_value('jam_tutup') ?>">
						<?php endif ?>
					</div>
					...
					<div class="form-group">
						...
						<select class="form-control form-control-warning form-txt-warning" id="ket"
							name="ket">
