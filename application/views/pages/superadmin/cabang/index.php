...
<div class="nama" data-flashdata="Cabang"></div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-12">
						<a href="<?= base_url('/cabang/tambah')?>" class="btn btn-success">Tambah Data</a>
						<hr>
					</div>
				</div>
				<div class="row">
								...
								<tr>
									...
									<td>
										<div class="table-actions">
											<a href="<?= base_url('/cabang/edit/'). $c->id_cabang?>"><i
													class="ik ik-edit text-success"></i></a>
											<a href="<?= base_url('/cabang/hapus/'). $c->id_cabang?>"
