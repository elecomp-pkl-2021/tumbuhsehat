                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="row border rounded" style="background-color: #E9ECEF; font-weight:bold;padding:5px;">
                            ...
                            <div class="col-md-10">
                                <input class="form-control form-control-sm" autocomplete="off" id="tanggal" name='from'></input>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col offset-lg-2 text-center my-auto">
                        <a href="<?php echo base_url('laporan/export_harian') ?>" class="btn btn-secondary my-auto"><i class="ik ik-download"></i>per-hari</a>
                    </div>
                    <div class="col text-center my-auto">
                        <a href="<?php echo base_url('laporan/export_per_dokter') ?>" class="btn btn-secondary"><i class="ik ik-download"></i>per-dokter</a>
                    </div>
                </div>
...
<script>
    ...
    function hubungan_pasien() {
        ...
        $.ajax({
            ...
            url: "<?= base_url('laporan/get_hubungan_pasien/' . $result->id_user) ?>",
...
<script>
    ...
    function filter_dokter() {
        ...
        var endDate = $('#tanggal').val();

        $.ajax({

            url: "<?= base_url('laporan/filter_laporan_harian') ?>",
