            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-2 offset-lg-5 text-right">
                        <a href="<?= base_url('laporan/export_per_dokter') ?>" class="btn btn-secondary"><i class="ik ik-download mr-2"></i>Download</a>
                    </div>
                </div>
                <div class="row mt-4">
...
<script>
    ...
    function filter_dokter() {
        ...
        $.ajax({
            url: "<?= base_url('laporan/filter_sharingfee') ?>",
            data: {
                id_dokter: id_dokter,
                interval: interval,
                endDate: endDate,
