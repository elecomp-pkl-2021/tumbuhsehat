                ...
                <div class="body">
                  <p style="font-size: 12px;"><i>
                    ...
                    <div class="form-group">
                        ...
                        <?php } else { ?> 
                          <font size="2px"><a href="#" class="col-md-10 btn-bayar" onclick="janji_datang('<?php echo $result->id_booking ?>')" style="color: white; padding: 5px; margin-top: 10px;">Lihat</a></font>  
                        <?php } ?> 
                    </div>    
                </div>    
              </div>
