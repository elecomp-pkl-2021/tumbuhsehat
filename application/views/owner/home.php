                  ...
                  <ul class="nav navbar-nav">
                    <li class="dropdown  mega-dropdown"> <a href="#" class="search-fam" data-toggle="" style="border-radius: 5px; padding: 7px; width: 200px; background-color: #f40049; color: white">
                      ...
                      <ul class="dropdown-menu mega-dropdown-menu row" style="padding: 30px;">
                        <div class="col-lg-12">
                          <div class="col-lg-3">
                              <input type="text" class="form-control" id="cari_nama" value="" placeholder="Cari Nama" autocomplete="off" style="background: #fff;border: 1px solid #eee;color:#000;" onkeypress="cari_data()">
                          </div>
                          <div class="col-lg-3">
                              <input type="text" class="form-control" id="cari_tgl_lahir" value="" placeholder="Cari Tgl Lahir" autocomplete="off" style="background: #fff;border: 1px solid #eee;color:#000;" onkeypress="cari_data()">
                          </div>
                          <div class="col-lg-3">
                              <input type="text" class="form-control" id="cari_nohp" value="" placeholder="Cari No.Hp" autocomplete="off" style="background: #fff;border: 1px solid #eee;color:#000;" onkeypress="cari_data()">
                          </div>
                          <div class="col-lg-3">
                              <input type="text" class="form-control" id="cari_email" value="" placeholder="Cari Email" autocomplete="off" style="background: #fff;border: 1px solid #eee;color:#000;" onkeypress="cari_data()">
                          </div>
                        </div><br />
                        <table id="all_data_json" data-toggle="table" data-url="<?php echo base_url('Klinik/data_keluarga'); ?>" data-show-refresh="false" data-show-toggle="false" data-show-columns="false" data-search="false" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="nama" data-sort-order="asc" data-toolbar="#toolbar">
                          <thead>
                            <tr>
                              <th data-formatter="numberFormatter" data-field="id_user" data-align="right">No</th>
                              <th data-field="nama_depan_u" data-sortable="true">Nama Akun Keluarga</th>
                              <th data-field="tanggal" data-formatter="true" data-align="center">Tanggal Lahir</th>
                    ...
                    <li>
                      <div class="form-group" style="">
                        <center><button class="btn btn-anim btn-white" style="width: 200px; border-radius: 5px" type="button" onclick="location.href ='<?php echo base_url('Owner/tambah_pasien.html'); ?>'"><span class="btn-text">Buat Akun Keluarga</span></button></center>
                ...
                <form action="<?php echo base_url('owner/add_booking'); ?>" method="post">
                  ...
                  <li class="dropdown mega-dropdown"> <a href="#" class="" data-toggle=""><b>Pilih Profil</b><br><br>
                    ...
                    <li class="dropdown mega-dropdown"> <a href="#" class="dropdown-toggle" data-toggle=""><b>Pilih Dokter</b><br><br><br>
                      ...
                      <ul class="dropdown-menu mega-dropdown-menu row" style="left: -558px;min-width: 218%;">

                      <span id="results"></span>
                      <div class="col-md-12">
                      <div align="center"><a href = "javascript:void(0)" onclick = "load_more()"><button type="button" class="btn btn-danger" style="width: 323px;height: 49px;">Lihat Dokter Lainnya..</button></a></div>
                      </div>  
                      </ul>
                    </li>       

                    <div id="ModalTolak" class="modal" style="top: 50px;">
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <!-- <div class="col-md-3">
          <button class="btn red col-sm-6" style="float: right; width: 100px; background-color:#f40049; color:white" type="button" onclick="pilih_filter()">Filter</button>
          </div> -->
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-4">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="col-md-12">
            <center>
              <font style="font-weight: bold; font-size: 17px;">Janji Yang Akan Datang</font><br><br>
            </center>
          </div>
          <!-- 
        <div class="col-md-6">
    ...
    <div class="col-lg-4">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="col-md-12">
            <center>
              <font style="font-weight: bold; font-size: 17px;">Pemeriksaan Berjalan</font><br><br>
            </center>
          </div>
          <!-- <div class="col-md-6">
          <div class="form-group">
    ...
    <div class="col-lg-4">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="col-md-12">
            <center>
              <font style="font-weight: bold; font-size: 17px;">Pemeriksaan Selesai</font><br><br>
            </center>
          </div>
          <!-- <div class="col-md-6">
          <div class="form-group">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){    
            ...
            $('#results').load("<?php echo site_url('Owner/load_produk'.$jenis)?>", {'offset':total_record}, function() {total_record++;});
                ...
                if(total_record <= total_groups)
            {
                loading = true; 
                $('.loader_image').show(); 
                $.post('<?php echo site_url('Owner/load_produk/'.$jenis) ?>',{'offset': total_record},
                function(data){ 
                    if (data != "") {                               
                        $("#results").append(data);                 
                        $('.loader_image').hide();                  
  ...
  function cari_data(){
    ...
    var cari_nohp = $("#cari_nohp").val();
    var cari_email = $("#cari_email").val();

    $('#all_data_json').bootstrapTable('refresh', {url: '<?php echo base_url()?>Klinik/data_keluarga/' + (cari_nama != ""? cari_nama : '') + (cari_tgl_lahir != ""? '/' + cari_tgl_lahir : '') + (cari_nohp != ""? '/' + cari_nohp : '') + (cari_email != ""? '/' + cari_email : '') });
  }
  ...
  function pilih_user(id) {
    $.get(linke + "owner/ajax_get_user/" + id, $(this).serialize())
      .done(function(data) {
        $('#id_user2').html(data);
      })
  }
...
<script>
  ...
  function profil() {
    ...
    $.ajax({
      url: "<?= base_url('owner/filter_profil') ?>",
      data: {
        id: id,
        tgl: tgl
      },
    ...
    $.ajax({
      url: "<?= base_url('owner/filter_profil_2') ?>",
      data: {
        id: id,
        tgl: tgl
      },
    ...
    $.ajax({
      url: "<?= base_url('owner/filter_profil_3') ?>",
      data: {
        id: id,
        tgl: tgl
      },
  ...
  function stok(value) {
    return '<div class="btn-group" role="group" aria-label="...">' +
      ...
      '<a href="<?php echo base_url(); ?>owner/home_keluarga/' + value + '.html" class="btn red" style="background-color:#f40049; color:white">&nbsp;&nbsp; Pilih &nbsp;&nbsp;</a>' +
      '</div>';
  }
</script>
</script>
