                  ...
                  <ul class="nav navbar-nav">
                    <li class="dropdown  mega-dropdown"> <a href="#" class="" data-toggle="" style="border-radius: 5px; padding: 7px; width: 200px; background-color:#f40049; color: white">
                      ...
                      <ul class="dropdown-menu mega-dropdown-menu row" style="padding: 30px;">
                        ...
                        <table id="all_data_json" data-toggle="table" data-url="<?php echo base_url('owner/data_keluarga'); ?>" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="nama" data-sort-order="asc" data-toolbar="#toolbar">
                          <thead>
                            <tr>
                              ...
                              <th data-field="email" data-sortable="true" data-align="left">Email</th><br>
...
<script>
  ...
  function stok(value) {
    return '<div class="btn-group" role="group" aria-label="...">' +
      ...
      '<a href="<?php echo base_url(); ?>owner/home_keluarga/' + value + '" class="btn red" style="background-color:#f40049; color:white">&nbsp;&nbsp; Lihat &nbsp;&nbsp;</a>' +
      '</div>';
