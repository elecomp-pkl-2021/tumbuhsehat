            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        ...
                        <font style="font-weight: bold; font-size: 20px;">Laporan Tahunan</font>

                        <a href="<?php echo base_url('owner/export_pemeriksaan_t') ?>" class="btn" style="margin-top: 45px; background-color: #e7e6e6; border: none; color:#f40049; font-weight:bold; float: right;">
    ...
    <script>
        ...
        function filter_dokter() {
            ...
            $.ajax({
                ...
                url: "<?= base_url('owner/filter_laporan_pemeriksaan_t') ?>",
