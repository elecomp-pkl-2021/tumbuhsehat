            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        ...
                        <font style="font-weight: bold; font-size: 20px;">Laporan Mingguan</font>

                        <a href="<?php echo base_url('owner/export_pemeriksaan_m') ?>" class="btn" style="margin-top: 45px; background-color: #e7e6e6; border: none; color:#f40049; font-weight:bold; float: right;">
                    ...
                    <div class="col-md-12" style="margin-top: 20px;">
                        ...
                        <div id="pemeriksaan_m_owner"></div>
    ...
    <script>
        ...
        function filter_dokter() {
            ...
            $.ajax({
                ...
                url: "<?= base_url('owner/filter_laporan_pemeriksaan_m') ?>",
