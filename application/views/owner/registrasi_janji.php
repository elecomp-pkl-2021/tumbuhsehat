												...
												<div class="modal-content">
													...
													<div class="col-lg-12">
														...
														<div class="modal-body">
															...
															<div class="col-lg-3">
																<button class="btn salmon" style="background-color:#F40049; color:white" > <p style="color:white;" id="jam_mulai_selesai"></p></button>
															</div>
															</div>
															<div class="form-group">
...
<script>
	...
	function JamPeriksa2(value, row, index){
		return row.jam_rencana_mulai+'-'+row.jam_rencana_selesai;
	}
	...
	function ubah_jadwal(id_booking){
		$('#modalUbahNew').show();
		$.ajax({
			url: "<?= base_url() ?>" + "index.php/owner/show_ubah_janji/" + id_booking,
			dataType: "JSON",
	...
	$("#tanggal_rencana_date_janji").on("change", function() {
		cek_waktu_booking_janji($('#id_booking').val(),$('#id_dokter').val(),$(this).val());
	});
	...
	function cek_waktu_booking_janji(id_booking, id_dokter, tanggal_rencana) {
		...
		$.ajax({
			url: "<?= base_url() ?>" + "index.php/owner/show_jadwal_dokter_janji/" + id_booking + "/" + id_dokter + "/" + tgl,
			dataType: "JSON",
			success: function(data) {
