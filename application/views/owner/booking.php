...
<script type='text/javascript'>
	...
	function prev3() {
		...
		var z = document.getElementById("data_diri1");
		// y.style.display = "block";
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="col-md-12">
						<h3 class="mb-20 weight-500"><b>Buat Janji Pemeriksaan</b></h3>
						<h5 class="mb-20 weight-500"><b>Rencana Pemeriksaan
								<?php foreach ($pasien->result() as $result) : ?>
									<?php echo $result->nama_depan; ?>
									<?php echo $result->nama_belakang; ?>
								<?php endforeach; ?>
							</b></h5>
						<h5 class="mb-20 weight-500">
							<!-- Escalade Dental - Jl. Tebet Dalam No. 10 -->
							<span>
								Drg.
								<?php foreach ($dokter2->result() as $dft_dokter) : ?>
									<?php echo $dft_dokter->nama_dokter; ?>
								<?php endforeach; ?>
							</span>
							<span>
								|
							...
							<span>
								<?php foreach ($cabang2->result() as $dft_cabang) : ?>
									<?php echo $dft_cabang->nama_cabang; ?>
									-
									<?php echo $dft_cabang->alamat; ?>
								<?php endforeach; ?>
							</span>
						...
						<div class="tab-content col-md-8">
							<div id="pilih_jadwal" class="tab-pane fade in active">
									...
									<div class="form-group">
										...
										<div class="col-lg-8">
											<div class="form-group box2">
												...
												<input type="text" class="form-control" rows="3" name="tanggal_rencana" id="tanggal_rencana">
											</div>
									...
									<div class="col-lg-8">
                                            ...
                                            <input type="hidden" name="jam_rencana_mulai">
                                            <input type="hidden" name="jam_rencana_selesai">
											...
											<!-- <?php
											$now = date('Y-m-d');
											$timestamp = strtotime('2021-04-16');
											$day = date('D', $timestamp); 
											echo $day;
											?> -->
											<div id="jam_rencana"></div>
											<!-- <div class="col-lg-12" style="margin-bottom: 23px;">
																<div class="col-lg-4">
																	<p style="text-align: center;">Pagi/Siang</p>
																	<?php 
																	$query = $this->db->query('select (SELECT COUNT(*) FROM rencana WHERE rencana.jam_rencana_mulai = jadwal_dokter.jam_mulai and rencana.jam_rencana_selesai=jadwal_dokter.jam_tutup) as jml, jadwal_dokter.* from jadwal_dokter where id_dokter="' . $result->id_dokter . '"');
																	...
																	//echo 'asu'.$r->jam_mulai;
																	if($r->ket=="Pagi/Siang"){	
																	?>
																	
																			<a href="#" onclick="cek_jadwal('<?php echo $r->id_jadwal ?>')" id="jadwal<?php echo $r->id_jadwal ?>" class="btn salmon stil1" style="float: right;margin-top: 7%;background-color:#ddd; color:black" <?php echo $disabled?> ><?php echo $r->jam_mulai?> - <?php echo $r->jam_tutup?></a><br /><br />	
																...
																<div class="col-lg-4">
																	<p style="text-align: center;">Malam</p>
																	<?php 
																	foreach($query->result() as $r){
																	//echo 'asu'.$r->jam_mulai;
																	if($r->ket=="Malam"){	
									...
									<button data-toggle="tab" href="#data_diri" type="button" class="btn salmon stil1" style="float: right;margin-top: 37%;background-color:#f40049; color:white">Selanjutnya</button>
							</div>
							<div id="data_diri" class="tab-pane fade">
								...
								<div id="data_diri1">
									...
									<?php foreach ($pasien->result() as $result) : ?>
										...
										<div class="col-lg-2">
											Belakang <?php echo form_error('nama_belakang') ?>
										</div>
										<div class="col-lg-4">
											<div class="form-group">
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												...
												<select class="form-control" name="tempat_lahir" id="descity" required >
										...
										<div class="col-lg-4">
											<div class="form-group ">
												<input class="form-control" rows="3" autocomplete="off" name="tanggal_lahir" placeholder="" id="tanggal_lahir" value="<?php echo $result->tanggal_lahir; ?>" required>
											</div>
										</div>
										<div class="col-lg-2">
											Jenis kelamin
										...
										<div class="col-lg-4">
											<div class="form-group box2">
												<select class="form-control" name="pekerjaan" id="pekerjaan" required>
													...
													<option value="Aparatur Sipil Negara" id="Aparatur Sipil Negara">Aparatur Sipil Negara</option>
													<option value="Pegawai BUMN" id="Pegawai BUMN">Pegawai BUMN</option>
													<option value="Pegawai Swasta" id="Pegawai Swasta">Pegawai Swasta</option>
													<option value="Wiraswasta" id="Wiraswasta">Wiraswasta</option>
										...
										<div class="col-lg-3">
											<div class="form-group box4">
												...
												<select class="form-control" name="provinsi" id="desprovince" required >
													<!-- <option> -- Pilih Provinsi -- </option> -->
												</select>    
												<input type="hidden" name="nama_provinsi" id="nama_provinsi" value="<?php echo $result->provinsi; ?>">  
											</div>
										</div>
										<div class="col-lg-1">
											Kota
										...
										<div class="col-lg-3">
											<div class="form-group box4">
												...
												<input type="hidden" name="nama_kota" id="nama_kota" value="<?php echo $result->kota_kab; ?>">  
											</div>
										</div>
										<div class="col-lg-1">
											Kode<br>Pos
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<!-- <select class="form-control" name="kode_pos" id="kode_pos" required >
										...
										<div id="data_diri2">
											...
											<button data-toggle="tab" href="#pilih_jadwal" type="button" class="btn salmon stil" style="float: left; margin-top: 20%; background-color:#f40049; color:white">Kembali</button>
											<button onclick="next1()" type="button" class="btn salmon" style="float: right; margin-top: 20%; background-color:#f40049; color:white">Selanjutnya</button>
										</div>
									<?php endforeach; ?>
								</div>
								...
								<div id="data_diri3" hidden>
									...
									<div class="col-lg-4">
										<div class="form-group box2">
											...
											<select class="form-control" name="tempat_lahir_dekat" id="descity_dekat" required >
														<option value="">-- Pilih Kota --</option>
											</select> 
										</div>
									</div>
									...
									<div class="col-lg-4">
										<div class="form-group">
											<input class="form-control" rows="3" autocomplete="off" name="tanggal_lahir_dekat" placeholder="" id="tanggal_lahir_dekat" required>
										</div>
									</div>
									<div class="col-lg-2">
										Jenis Kelamin
									...
									<div class="col-lg-3">
										<div class="form-group box4">
											<select class="form-control" name="provinsi" id="desprovince_dekat" required >
													<!-- <option> -- Pilih Provinsi -- </option> -->
											</select>    
											<input type="hidden" name="nama_provinsi_dekat" id="nama_provinsi_dekat" >  
										</div>
									</div>
									<div class="col-lg-2">
										Kota/Kab
									...
									<div class="col-lg-3">
										<div class="form-group box4">
											...
											<input type="hidden" name="nama_kota_dekat" id="nama_kota_dekat">  
										</div>
									</div>
									...
									<div class="col-md-12" id="data_diri4">
									...
									<div class="col-lg-5">
										<div class="form-group box5" required>
									...
									<button onclick="prev3()" type="button" class="btn salmon" style="float: left;  margin-top: 25%; background-color:#f40049; color:white">Kembali</button>
									<button data-toggle="tab" href="#keluhan" type="button" class="btn salmon stil2" style="float: right;margin-top: 25%;background-color:#f40049; color:white">Selanjutnya</button>
							...
							<div id="keluhan" class="tab-pane fade">
								...
								<div class="col-lg-12">
									...
									<button data-toggle="tab" href="#data_diri" type="button" class="btn salmon stil2" style="float: left;margin-top: 17%; background-color:#f40049; color:white">Kembali</button>
									<button data-toggle="tab" href="#metode_pembayaran" type="button" class="btn salmon stil3" style="float: right;margin-top: 17%; background-color:#f40049; color:white">Selanjutnya</button>
								</div>
							</div>
							<div id="metode_pembayaran" class="tab-pane fade">
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<button class="btn salmon col-sm-4 " style="float: right; height: 50px; width: 25%; background-color:#f40049; color:white" type="submit">Simpan</button>
									</div>
								</div>
							...
							<div id="konfirmasi_booking" class="tab-pane fade">
								...
								<div class="row col-lg-11">
									<div class="title-content">
										Saat ini kami sedang memastikan rencana pemeriksaan kamu berjalan dengan lancar. Apabila sudah terkonfirmasi kami akan mengirimkan kode booking melalui whatsapp dan email.
									</div>
									<div class="title-content">
										Apabila kamu tidak mendapatkan konfirmasi kode booking dari kami selama 1 x 24 jam, maka kamu dapat menghubungi kami melalui email <a href="">escalladeclinic@gmail.com</a> atau telepon (021) 714986
									</div>
								</div>
								<div class="row col-lg-5 mt-f">
									<a href="" class="btn btn-sm btn-success mt-9" data-formatter="lanjut" style="background-color:#f40049; color:white" data-align="center">Kembali ke Beranda</a>
								</div>
							</div>
						</div>
						</form>
...
<script>
	var tempat_lahir = "<?php echo $result->tempat_lahir?>";
	var provinsi = "<?php echo $result->provinsi?>";
	var idprovince = "<?php echo $result->province_id?>";
	var kota_kab = "<?php echo $result->kota_kab ?>";
	var idcity = "<?php echo $result->city_id ?>";
	...
	$("#tanggal_lahir_dekat").datepicker({
		monthNames: ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni',
			'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'
		],
		dayNamesMin: ['Min', 'Sen', 'Sel', 'Rab', 'Ka', 'Jum', 'Sab'],
	...
	$(document).ready(function() {
		...
		var idprovince_dekat = $('#desprovince_dekat').val();
		// console.log('idprovince', idprovince);
		// loadCity2(idprovince,'#kota_kab');

		loadCity('#descity');
		loadProvinsi(idprovince,'#desprovince');
		loadCity2(idcity,'#kota_kab',idprovince);

		loadCityDekat('#descity_dekat');
		loadProvinsiDekat('#desprovince_dekat');
		loadCity2Dekat('#kota_kab_dekat',idprovince_dekat);
	});
		...
		$('#desprovince').change(function(){
			...
			loadCity2(idcity,'#kota_kab',idprovince);
			$('#nama_provinsi').val(getSelectedText('desprovince'));
		});
		$('#kota_kab').change(function(){
			$('#nama_kota').val(getSelectedText('kota_kab'));
			var idkota = $('#kota_kab').val();
		//	loadKodePos(idkota,'#kode_pos');
		});

		$('#desprovince_dekat').change(function(){
			$('#kota_kab_dekat').show();
			var idprovince_dekat = $('#desprovince_dekat').val();
			loadCity2Dekat('#kota_kab_dekat',idprovince_dekat);
			$('#nama_provinsi_dekat').val(getSelectedText('desprovince_dekat'));
		});

		$('#kota_kab_dekat').change(function(){
			$('#nama_kota_dekat').val(getSelectedText('kota_kab_dekat'));
			//var idkota = $('#kota_kab').val();
		//	loadKodePos(idkota,'#kode_pos');
		});
		...
		function loadCity(id){
			$.ajax({
				url: '<?php echo base_url("Owner/showcity/");?>'+'/',
				dataType:'json',
				...
				city = '';
					...
					$.each(response['rajaongkir']['results'], function(i,n){
						...
						if(tempat_lahir == n['type']+" "+n['city_name']){
							city = '<option value="'+n['type']+" "+n['city_name']+'" selected>'+n['type']+" "+n['city_name']+'</option>';
						}else{
							city = '<option value="'+n['type']+" "+n['city_name']+'">'+n['type']+" "+n['city_name']+'</option>';
						}	
						city = city + '';
						$(id).append(city);
					});
		...
		function loadProvinsi(idprovince, id){
			...
			$.ajax({
			url: '<?php echo base_url("Owner/showprovince");?>',
			dataType:'json',
			success:function(response){
				$(id).html('');
				province = '';
		...
		function loadCity2(idcity,id,idprovince2){
			$.ajax({
			url: '<?php echo base_url("Owner/showcity2/");?>'+'/'+idprovince2,
			dataType:'json',
			data:{province:idprovince2},
			success:function(response){
				$(id).html('');
				city = '';
		...
		function loadCity2Dekat(id,idprovince2){
			$.ajax({
			url: '<?php echo base_url("Owner/showcity2/");?>'+'/'+idprovince2,
			dataType:'json',
			data:{province:idprovince2},
	...
	// function loadKodePos(idkota, id){
	// 	$.ajax({
	// 	url: '<?php echo base_url("Owner/showkodepos/");?>'+'/'+idkota,
	// 	dataType:'json',
	// 	data:{id:idkota},
	// 	success:function(response){
	// 		$(id).html('');
	...
	// 		$.each(response['rajaongkir']['results'], function(i,n){
	// 			console.log("key: " + i + " Value: " + n['postal_code']);
	// 			// console.log('n', n['postal_code']);
	// 			// city = '<option value="'+n['city_id']+'">'+n['type']+" "+n['city_name']+'</option>';
	// 			// console.log('city_id', n['city_id']);
	// 			// city = city + '';
	// 			// $(id).append(city);
	// 		});
	// 	},
