							...
							<div id="proses_bayar" class="tab-pane fade" style="margin-left: -20px">
									<div class="col-md-12">
										...
										<div class="col-lg-10" style="background: #ccc; color: #000; padding: 7px 0 6px 10px;">
											<b>TOTAL : <p id="txttot" style="float: right; color: #000; margin: 0 20px 0 0;">Rp. <?= $total->subtotal ?></p></b>
										</div>
										...
										<div class="col-lg-10" style="background: #f40049; color: #fff; padding: 7px 0 6px 10px;">
											<b style="padding: 5px 0 5px 0;"> GRAND TOTAL :
												<p style="float: right; color: #fff; margin-bottom: 0;">Rp. <input type="text" value="<?= $total->grandtotal ?>" name="grandtotal" id="grandtotal" style="float:right; color:#fff; margin-left: 3px;  width: 65px; border: 0px; background: #f40049;"></p></b>
										</div>
