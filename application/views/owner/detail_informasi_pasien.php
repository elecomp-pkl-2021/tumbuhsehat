...
<script>
  ...
  function pemeriksaan_klinis() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('owner/filter_pemeriksaan_klinis') ?>",
      data: {
        tgl: tgl,
        id: id
      },
  ...
  //Filter Pemeriksaan Klinis Khusus
  $(document).ready(function() {
  ...
  function pemeriksaan_klinis_khusus() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('owner/filter_pemeriksaan_klinis_khusus') ?>",
      data: {
        tgl: tgl,
        id: id
      },
  ...
  //Filter Pemeriksaan Penunjang Radiologi
  $(document).ready(function() {
  ...
  function pemeriksaan_penunjang_radiologi() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('owner/filter_pemeriksaan_penunjang_radiologi') ?>",
      data: {
        tgl: tgl,
        id: id
      },
  ...
  function pemeriksaan_penunjang_laboratorium() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('owner/filter_pemeriksaan_penunjang_laboratorium') ?>",
      data: {
        tgl: tgl,
        id: id
      },
