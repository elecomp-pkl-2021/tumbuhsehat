					...
					<div class="kotak">
						...
						<div class="tab-content col-md-8">
							<div id="pilih_jadwal" class="tab-pane fade in active">
								<form action="<?php echo base_url('klinik/create_action/'); ?>" method="post" enctype="multipart/form-data">
							...
							<div id="keluhan" class="tab-pane fade">
								...
								<div class="col-lg-8">
									<div class="form-group">
										<input type="text" class="form-control" rows="3" name="tanggal_keluhan" id="datepicker" required>
									</div>
								</div>
								<div class="col-lg-12">
									<div class="form-group">
