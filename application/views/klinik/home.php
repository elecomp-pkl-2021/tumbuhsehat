                  ...
                  <ul class="nav navbar-nav">
                    <li class="dropdown  mega-dropdown"> <a href="#" class="search-fam" data-toggle="" style="border-radius: 5px; padding: 7px; width: 200px; background-color: #f40049;; color: white">
                      ...
                      <ul class="dropdown-menu mega-dropdown-menu row" style="padding: 30px;">
                        ...
                        <table id="all_data_json" data-toggle="table" data-url="<?php echo base_url('klinik/data_keluarga'); ?>" data-search="false" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="nama" data-sort-order="asc" data-toolbar="#toolbar">
                          <thead>
                            <tr>
                    ...
                    <li>
                      <div class="form-group" style="">
                        <center><button class="btn btn-anim btn-white" style="width: 200px; border-radius: 5px" type="button" onclick="location.href ='<?php echo base_url('Klinik/tambah_pasien.html'); ?>'"><span class="btn-text">Buat Akun Keluarga</span></button></center>
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="col-md-3">
            <div class="form-group box2">
              <select id="filter_p" class="form-control" style="width: 241px;"> 
...
<script>
  ...
  function stok(value) {
    return '<div class="btn-group" role="group" aria-label="...">' +
      ...
      '<a href="<?php echo base_url(); ?>klinik/home_keluarga/' + value + '.html" class="btn red" style="background-color:#f40049; color:white">&nbsp;&nbsp; Pilih &nbsp;&nbsp;</a>' +
      '</div>';
