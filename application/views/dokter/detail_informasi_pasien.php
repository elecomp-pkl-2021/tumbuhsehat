...
<script type='text/javascript'>
  ...
  $(window).load(function() {
    $(".stileone2").on("click", function() {
      $(".stileone2").css("color", "#f40049");
      $(".stileone2").css("border-bottom", "3px solid #F6336D");
      $(".stileone1").css("color", "#000");
      $(".stileone1").css("border-bottom", "none");
      $(".stileone").css("color", "#000");
      $(".stileone").css("border-bottom", "none");
  ...
  $(window).load(function() {
    $(".stileone3").on("click", function() {
      $(".stileone3").css("color", "#f40049");
      $(".stileone3").css("border-bottom", "3px solid #F6336D");
      $(".stileone1").css("color", "#000");
      $(".stileone1").css("border-bottom", "none");
      $(".stileone2").css("color", "#000");
      $(".stileone2").css("border-bottom", "none");
  ...
  $(window).load(function() {
    $(".stileone4").on("click", function() {
      $(".stileone4").css("color", "#f40049");
      $(".stileone4").css("border-bottom", "3px solid #F6336D");
      $(".stileone1").css("color", "#000");
      $(".stileone1").css("border-bottom", "none");
      $(".stileone2").css("color", "#000");
      $(".stileone2").css("border-bottom", "none");
  ...
  $(window).load(function() {
    $(".stileone5").on("click", function() {
      $(".stileone5").css("color", "#f40049");
      $(".stileone5").css("border-bottom", "3px solid #F6336D");
      $(".stileone1").css("color", "#000");
      $(".stileone1").css("border-bottom", "none");
      $(".stileone2").css("color", "#000");
      $(".stileone2").css("border-bottom", "none");
...
<style type="text/css">
  @media only screen and (max-width: 800px) {
    .stileone {
      color: #f40049;
      border-bottom: 3px solid #F6336D;
    }
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <font style="margin-left: 20px; font-weight: bold; font-size: 20px;">Informasi Pasien</font>
            </div>
            <div class=" col-md-12">
              <div class=" col-md-8">
              </div>
              <div class=" col-md-4">
                <a style="float: right; height: 35px; width: 250px; background-color: #f40049; color: white; border-radius: 5px;" class="btn btn-anim"><b>&nbsp;&nbsp;Download Informasi Pasien</b></a>
              </div>
            </div>
          ...
          <?php foreach ($info->result() as $info) : ?>
            <div class="col-md-12" style="border: 1px solid #e0e0e0; margin-top: 15px;">
              <div class="col-md-4"><br>
                <font style="font-weight: bold; font-size: 18px;"><?php echo $info->nama_depan ?> <?php echo $info->nama_belakang ?></font>
                <span>
                  (<?php echo $info->jenis_kelamin ?>,
                  <?php $awal  = strtotime($info->tanggal_lahir); //Waktu awal
                  $akhir = time(); // Waktu sekarang atau akhir
                  $diff  = $akhir - $awal;
                  echo floor($diff / (60 * 60 * 24 * 365)) . ' Tahun'; ?>)
                </span><br><br>
                <p><?php echo $info->hubungan ?></p>
                <p>No. Rekam Medis <?php echo $info->id_rekam_medis ?></p>
              </div>
              ...
              <div class="col-md-4" style="border-left: 1px solid #e0e0e0;">
                ...
                <br><br>
                <p><?php echo $info->tanggal_rencana ?> <span style="margin-left: 30px;">Drg. <?php echo $info->nama_dokter ?></span> </p>
                <p>(<?php echo $info->jam_rencana_mulai ?> - <?php echo $info->jam_rencana_selesai ?>)
                  ...
                  <?php } elseif ($info->status == 1) { ?>
                    <span style="margin-left: 60px;" class="label label-success">Sudah Terdaftar</span>
                  <?php } ?>
                </p>
              </div>
              <div class="col-md-4" style="border-left: 1px solid #e0e0e0;"><br>
                ...
                <br><br>
                <p><b>No HP :</b><span> <?php echo $info->no_hp ?></span></p>
                <p><b>Email :</b><span> <?php echo $info->email ?></span></p>
              </div>
            </div>
          <?php endforeach;  ?>
          <div class="kotak">
            ...
            <div class="tab-content col-md-12">
              <div id="umum" class="tab-pane fade in active">
                <div class="col-md-12"><br>
                  <?php foreach ($info_umum->result() as $umum) { ?>
                    <div class="col-md-6">
                      <div class="col-md-12">
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->tempat_lahir ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">Tanggal Lahir</font>
                      </div>
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->tanggal_lahir ?></p>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->jenis_kelamin ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">Status Pernikahan</font>
                      </div>
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->status_nikah ?></p>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->pekerjaan ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">Pendidikan</font>
                      </div>
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->pendidikan ?></p><br>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->jenis_id ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">No ID</font>
                      </div>
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->no_id ?></p>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6" style="border-left: 1px solid #e0e0e0;">
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->nama_depan_dekat ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">Nama Belakang</font>
                      </div>
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->nama_belakang_dekat ?></p>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->tempat_lahir_dekat ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">Tanggal Lahir</font>
                      </div>
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->tanggal_lahir_dekat ?></p>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->jenis_kelamin_dekat ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">Status Pernikahan</font>
                      </div>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->jenis_id_dekat ?></p>
                      </div>
                      <div class="col-md-3" style="border-left: 1px solid #e0e0e0;"><br>
                        <font style="font-size: 16px;">No ID</font>
                      </div>
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->no_id_dekat ?></p>
                      </div>
                    ...
                    <div class="col-md-6" style="border-left: 1px solid #e0e0e0;">
                      ...
                      <div class="col-md-8"><br>
                        <p><?php echo $umum->alamat_dekat ?></p>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->kota_kab_dekat ?></p>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->provinsi_dekat ?></p>
                      </div>
                      <div class="col-md-6"></div>
                      <div class="col-md-6"></div>
                      <div class="col-md-3"><br>
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->kode_pos_dekat ?></p>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="col-md-3"><br>
                        <p><?php echo $umum->riwayat_penyakit ?></p>
                      </div>
                    </div>
                </div>
              <?php } ?>
              ...
              <div id="pemeriksaan_klinis" class="tab-pane fade">
                <?php foreach ($info_klinis->result() as $info) { ?>
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input id="filter_tanggal_pemeriksaan_klinis" type="date">
                  ...
                  <input id="id_pasien" value="<?php echo $info->id_pasien ?>" hidden>
                  <div id="tampilan_pemeriksaan_klinis" class="col-md-12"></div>
                    ...
                    <div class="col-md-12"><br>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="col-md-9">
                          <div class="form-group">
                            <input id="filter_tanggal_pemeriksaan_klinis_khusus" type="date">
                              <?php foreach ($tanggal_periksa_penunjang->result() as $tgl) { ?>
                              <!-- <?php echo $tgl->tanggal_periksa ?> -->
                              <?php } ?>
                            </input>
                      ...
                      <div id="tampilan_pemeriksaan_klinis_khusus" class="col-md-8"></div>
                    </div>
                <?php } ?>
              </div>
                ...
                <?php foreach ($info_penunjang->result() as $info) : ?>
                  <div class="col-md-12"><br>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-9">
                        <div class="form-group">
                          <input id="filter_tanggal_pemeriksaan_penunjang_radiologi" type="date">
                            <?php foreach ($tanggal_periksa_penunjang->result() as $tgl) { ?>
                            <!-- <?php echo $tgl->tanggal_periksa ?> -->
                            <?php } ?>
                          </input>
                    ...
                    <div id="tampilan_pemeriksaan_penunjang_radiologi"></div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="col-md-9">
                        <div class="form-group">
                          <input id="filter_tanggal_pemeriksaan_penunjang_laboratorium" type="date">
                          <?php foreach ($tanggal_periksa_penunjang->result() as $tgl) { ?>
                          <!-- <?php echo $tgl->tanggal_periksa ?> -->
                          <?php } ?>
                          </input>
                    ...
                    <div id="tampilan_pemeriksaan_penunjang_laboratorium"></div>
                  </div>
                <?php endforeach; ?>
              </div>
              ...
              <div id="summary_rekam_medis" class="tab-pane fade">
                ...
                <table id="table2" data-url="<?php echo base_url('Doctor/get_summary_rekam_medis/'.$info->id_pasien);?>" data-toggle="table" data-show-refresh="false" data-show-toggle="false" data-show-columns="false" data-search="true" data-select-item-name="toolbar1" data-sort-name="awal_periode_renop" data-sort-order="desc" data-pagination="false">
                            <thead>
                                <tr>
...
function pemeriksaan_klinis() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('doctor/filter_pemeriksaan_klinis') ?>",
      data: {
        tgl: tgl,
        id: id
      },
      success: function(data) {
        $('#tampilan_pemeriksaan_klinis').html(data);
      }
    });
}
...
function pemeriksaan_klinis_khusus() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('doctor/filter_pemeriksaan_klinis_khusus') ?>",
      data: {
        tgl: tgl,
        id: id
      },
...
function pemeriksaan_penunjang_radiologi() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('doctor/filter_pemeriksaan_penunjang_radiologi') ?>",
      data: {
        tgl: tgl,
        id: id
      },
...
function pemeriksaan_penunjang_laboratorium() {
    ...
    $.ajax({
      type: "POST",
      url: "<?= base_url('doctor/filter_pemeriksaan_penunjang_laboratorium') ?>",
      data: {
        tgl: tgl,
        id: id
      },
...
$("#filter_all").click(function () {
    ...
    //  console.log(kel, subkel)
      $('#table2').bootstrapTable('refresh', {url: '<?php echo base_url() ?>Doctor/get_summary_rekam_medis/' + (id_pasien2 != ""? id_pasien2 : '') + (dokter != ""? '/' + dokter : '') + (tgl != ""? '/' + tgl : '')});
});
...
function summary(value, row, index){
      ...
      <p>
                          ...
                          <p>
                            <font style="color: #F6336D; font-weight: bold; "> O : </font><span><b>Pemeriksaan Klinis Khusus: </b>${row.keterangan}</span>
                          ...
                          <p>
                            <font style="color: #F6336D; font-weight: bold; "> A : </font><span>Gigi ${row.elemen_gigi} ${row.diagnosis}</span>
                          </p>
                          <p>
                            <font style="color: #F6336D; font-weight: bold; "> P : </font><span>${row.layanan} ${row.elemen_gigi}(${row.detail_layanan})</span>
                          </p>
      `;
}
...
function load_odontogram(){
    ...
    $.get("<?php echo base_url() ?>Doctor/create_load_odontogram", {tgl_awal:tgl_awal, id_pasien3:id_pasien3}, function(data){
        $('#kota').html(data);
    });
} 
</script>