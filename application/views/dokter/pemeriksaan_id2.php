						...
						<div class="col-lg-2">	
							<div class="form-group ">	
								<input type='radio' class="" rows="3" name="wajah" value="Asimetri"> Asimetri
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="wajah" required value="Simetri" <?= $umum->wajah == 'Simetri' ? 'checked' : null ?>> Simetri
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group ">
													<input type='radio' class="" rows="3" name="wajah" value="Asimetri" <?= $umum->wajah == 'Asimetri' ? 'checked' : null ?>> Asimetri
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
								...
								<div class="form-group">	
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="bibir1" required value="Normal" <?= $umum->bibir == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="bibir1" value="" <?= $umum->bibir != 'Normal' ? 'checked' : null ?>> Lainnya :
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="bibir2" value="<?= $umum->bibir != 'Normal' ? $umum->bibir : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
								...
								<input type='radio' class="" rows="3" name="submandibula_kanan2" value="Tidak Sakit" > Tidak Sakit
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kanan1" required value="Teraba" <?= $umum->submandibula_kanan == 'Teraba' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Teraba,Tidak Sakit' ? 'checked' : null ?>> Teraba
												</div>
											</div>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kanan1" value="Tidak Teraba" <?= $umum->submandibula_kanan == 'Tidak Teraba' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Tidak Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Tidak Teraba,Tidak Sakit' ? 'checked' : null ?>> Tidak Teraba
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kanan2" value="Sakit" <?= $umum->submandibula_kanan == 'Sakit' ? 'checked' : null ?><?= $umum->submandibula_kanan == 'Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Tidak Teraba,Sakit' ? 'checked' : null ?>> Sakit
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kanan2" value="Tidak Sakit" <?= $umum->submandibula_kanan == 'Tidak Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Teraba,Tidak Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kanan == 'Tidak Teraba,Tidak Sakit' ? 'checked' : null ?>> Tidak Sakit
												</div>
											</div>
						...
						<input type='radio' class="" rows="3" name="submandibula_kiri2" value="Tidak Sakit" > Tidak Sakit
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kiri1" required value="Teraba" <?= $umum->submandibula_kiri == 'Teraba' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Teraba,Tidak Sakit' ? 'checked' : null ?>> Teraba
												</div>
											</div>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kiri1" value="Tidak Teraba" <?= $umum->submandibula_kiri == 'Tidak Teraba' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Tidak Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Tidak Teraba,Tidak Sakit' ? 'checked' : null ?>> Tidak Teraba
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kiri2" value="Sakit" <?= $umum->submandibula_kiri == 'Sakit' ? 'checked' : null ?><?= $umum->submandibula_kiri == 'Teraba,Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Tidak Teraba,Sakit' ? 'checked' : null ?>> Sakit
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="submandibula_kiri2" value="Tidak Sakit" <?= $umum->submandibula_kiri == 'Tidak Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Teraba,Tidak Sakit' ? 'checked' : null ?> <?= $umum->submandibula_kiri == 'Tidak Teraba,Tidak Sakit' ? 'checked' : null ?>> Tidak Sakit
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="lainnya" value=""> 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-8">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="lainnya" value="<?= $umum->lainnya != NULL ? $umum->lainnya  : null ?>">
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="gingiva2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="gingiva1" required value="Normal" <?= $umum->gingiva == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="gingiva1" value="" <?= $umum->gingiva != 'Normal' ? 'checked' : null ?>> Ada Kelainan :
												</div>
											</div>

											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="gingiva2" value="<?= $umum->gingiva != 'Normal' ? $umum->gingiva : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
								...
								<input type='text' class="form-control" rows="3" name="debris2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="debris1" required value="Normal" <?= $umum->debris == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="debris1" value="" <?= $umum->debris != 'Normal' ? 'checked' : null ?>> Ada Kelainan :
												</div>
											</div>

											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="debris2" value="<?= $umum->debris != 'Normal' ? $umum->debris : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
								...
								<input type='radio' class="" rows="3" name="stain" value="Tidak Ada" > Tidak Ada
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="stain" required value="Ada" <?= $umum->stain == 'Ada' ? 'checked' : null ?>> Ada
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="stain" value="Tidak Ada" <?= $umum->stain == 'Tidak Ada' ? 'checked' : null ?>> Tidak Ada
												</div>
											</div>
								...
								<input type='radio' class="" rows="3" name="kalkulus" value="Supragingiva" > Supragingiva
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="kalkulus" required value="Tidak Ada" <?= $umum->kalkulus == 'Tidak Ada' ? 'checked' : null ?>> Tidak Ada
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="kalkulus" value="Subgingiva" <?= $umum->kalkulus == 'Subgingiva' ? 'checked' : null ?>> Subgingiva
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="kalkulus" value="Supragingiva" <?= $umum->kalkulus == 'Supragingiva' ? 'checked' : null ?>> Supragingiva
												</div>
											</div>
								...
								<input type='text' class="form-control" rows="3" name="mukosa2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="mukosa1" required value="Normal" <?= $umum->mukosa == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="mukosa1" value="" <?= $umum->mukosa != 'Normal' ? 'checked' : null ?>> Ada Kelainan :
												</div>
											</div>

											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="mukosa2" value="<?= $umum->mukosa != 'Normal' ? $umum->mukosa : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
								...
								<input type='text' class="form-control" rows="3" name="palatum2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="palatum1" required value="Normal" <?= $umum->palatum == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="palatum1" value="" <?= $umum->palatum != 'Normal' ? 'checked' : null ?>> Ada Kelainan :
												</div>
											</div>

											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="palatum2" value="<?= $umum->palatum != 'Normal' ? $umum->palatum : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
								...
								<input type='text' class="form-control" rows="3" name="lidah2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="lidah1" required value="Normal" <?= $umum->lidah == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="lidah1" value="" <?= $umum->lidah != 'Normal' ? 'checked' : null ?>> Ada Kelainan :
												</div>
											</div>

											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="lidah2" value="<?= $umum->lidah != 'Normal' ? $umum->lidah : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
						...
						<div class="col-lg-6">
								...
								<input type='text' class="form-control" rows="3" name="dasar_mulut2" > 
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="dasar_mulut1" required value="Normal" <?= $umum->dasar_mulut == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="dasar_mulut1" value="" <?= $umum->dasar_mulut != 'Normal' ? 'checked' : null ?>> Ada Kelainan :
												</div>
											</div>

											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="dasar_mulut2" value="<?= $umum->dasar_mulut != 'Normal' ? $umum->dasar_mulut : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="hubungan_rahang" required value="Ortognati" <?= $umum->hubungan_rahang == 'Ortognati' ? 'checked' : null ?>> Ortognati
												</div>
											</div>
											<div class="col-lg-4 text-center">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="hubungan_rahang" value="Retrognati" <?= $umum->hubungan_rahang == 'Retrognati' ? 'checked' : null ?>> Retrognati
												</div>
											</div>
											<div class="col-lg-4">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="hubungan_rahang" value="Prognati" <?= $umum->hubungan_rahang == 'Prognati' ? 'checked' : null ?>> Prognati
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
									...
									<?php foreach ($pemeriksaan_umum->result() as $umum) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="kelainan_gigi_geligi1" required value="Normal" <?= $umum->kelainan_gigi_geligi == 'Normal' ? 'checked' : null ?>> Normal
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="kelainan_gigi_geligi1" value="" <?= $umum->kelainan_gigi_geligi != 'Normal' ? 'checked' : null ?>> Ada Kelainan :
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="kelainan_gigi_geligi2" value="<?= $umum->kelainan_gigi_geligi != 'Normal' ? $umum->kelainan_gigi_geligi : null ?>">
												</div>
											</div>
										<?php } ?>
									<?php endforeach; ?>
							...
							<div class="form-group">
								<textarea name="keterangan_khusus" class="form-control" placeholder="46 Only, vitalitas(+), perkusi(+), palpasi(-)." rows="10" ></textarea>
									...
									<?php foreach ($pemeriksaan_khusus->result() as $khusus) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>

											<div class="col-lg-12">
												<div class="form-group">
													<textarea name="keterangan_khusus" class="form-control" placeholder="46 Only, vitalitas(+), perkusi(+), palpasi(-)." rows="10" required><?= $khusus->keterangan != NULL ? $khusus->keterangan : null ?></textarea>
												</div>
											</div>
								...
								<div id="keluhan4" hidden>
									...
									<!-- 						<div class="col-lg-2">	
							<div class="form-group">	
								<input type='radio' class="" rows="3" name="panoramik" value="Panoramik"> Panoramik
							</div>
						</div>
						<div class="col-lg-2">	
							<div class="form-group">	
								<input type='radio' class="" rows="3" name="sefalometri" value="Sefalometri" > Sefalometri
							</div>
						</div>
						<div class="col-lg-2">	
							<div class="form-group">	
								<input type='radio' class="" rows="3" name="transcranial" value="Transcranial" > Transcranial
							</div>
						</div>
						<div class="col-lg-2">	
							<div class="form-group">	
								<input type='radio' class="" rows="3" name="dental_regio" value="Dental Regio" > Dental,Regio 
							</div>
						</div>
						...
						<div class="col-lg-12">	
							<div class="form-group">
								<textarea name="keterangan_radiologi" class="form-control" placeholder="Tampak gambaran radiopak ada oklusal gigi 46 hingga dentin dalam. Tampak gambaran radiolusensi berbatas diffuse pada apical seluas kurang lebih 4 mm." rows="5" ></textarea>
									...
									<?php foreach ($pemeriksaan_penunjang->result() as $penunjang) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>

											<div class="col-lg-2">
												<div class="form-group">
													<input type='checkbox' class="" rows="3" name="panoramik" value="Panoramik" <?= $penunjang->radiologi == 'Panoramik' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Transcranial,Dental Regio' ? 'checked' : null ?>> Panoramik
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='checkbox' class="" rows="3" name="sefalometri" value="Sefalometri" <?= $penunjang->radiologi == 'Sefalometri' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Sefalometri,Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Sefalometri,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Sefalometri,Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Transcranial,Dental Regio' ? 'checked' : null ?>> Sefalometri
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='checkbox' class="" rows="3" name="transcranial" value="Transcranial" <?= $penunjang->radiologi == 'Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Sefalometri,Transcranial' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Sefalometri,Transcranial,Dental Regio' ? 'checked' : null ?>> Transcranial
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='checkbox' class="" rows="3" name="dental_regio" value="Dental Regio" <?= $penunjang->radiologi == 'Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Panoramik,Sefalometri,Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Sefalometri,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Sefalometri,Transcranial,Dental Regio' ? 'checked' : null ?> <?= $penunjang->radiologi == 'Transcranial,Dental Regio' ? 'checked' : null ?>> Dental,Regio
												</div>
											</div>
											<div class="col-lg-4" style="float: right;">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="gigi" value="<?= $penunjang->gigi != NULL ? $penunjang->gigi : null ?>" placeholder="46">
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group">
													<textarea name="keterangan_radiologi" class="form-control" placeholder="Tampak gambaran radiopak ada oklusal gigi 46 hingga dentin dalam. Tampak gambaran radiolusensi berbatas diffuse pada apical seluas kurang lebih 4 mm." rows="5"><?= $penunjang->keterangan_radiologi != NULL ? $penunjang->keterangan_radiologi : null ?></textarea>
												</div>
											</div>
								...
								<textarea name="keterangan_laboratorium" class="form-control" placeholder="Tidak ada" rows="5" ></textarea>
									...
									<?php foreach ($pemeriksaan_penunjang->result() as $penunjang) : ?>
										<?php if ($this->db->affected_rows() > 0) { ?>
											...
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="laboratorium1" value="Darah Rutin" <?= $penunjang->laboratorium == 'Darah Rutin' ? 'checked' : null ?>> Darah Rutin
												</div>
											</div>
											<div class="col-lg-2">
												<div class="form-group">
													<input type='radio' class="" rows="3" name="laboratorium1" value="" <?= $penunjang->laboratorium != 'Darah Rutin' ? 'checked' : null ?>> Lainnya
												</div>
											</div>
											<div class="col-lg-8">
												<div class="form-group">
													<input type='text' class="form-control" rows="3" name="laboratorium2" value="<?= $penunjang->laboratorium != 'Darah Rutin' ? $penunjang->laboratorium : null ?>">
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group">
													<textarea name="keterangan_laboratorium" class="form-control" placeholder="Tidak ada" rows="5"><?= $penunjang->keterangan_laboratorium != NULL ? $penunjang->keterangan_laboratorium : null ?></textarea>
												</div>
											</div>
