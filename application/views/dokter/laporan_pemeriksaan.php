...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" style="">
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo base_url('doctor/export_pemeriksaan') ?>" class="btn" style="margin-top: 45px; background-color: #e7e6e6; border: none; color:#f40049; font-weight:bold; float: right;">
    ...
    <script>
        ...
        function conversion_rate() {
            ...
            // $.ajax({
            //   url : "<?= base_url('doctor/get_survey_rate/' . $id_dokter) ?>",
            //   data : {cr:cr},
            //   success:function(data){
            //       // console.log(data);
            //     $('#txtconv').html(data);
