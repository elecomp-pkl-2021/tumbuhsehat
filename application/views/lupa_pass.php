     ...
     <div class="col-md-12">
      ...
      <div class="wow">
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
            <input id="myInput_2" type="password" name="passconf" class="form-control" placeholder="Password" maxlength="15" required="required" onchange="cek_pass(this.value)"/>
          </div>
        ...
        <div class="form-group">
				    ...
				    <input type="hidden" name="cekemailin" value="0" id="cekemailin">

						<div class="md-form" id="dur_pass2">

											

					    <label class="btn_2 rounded" for="inputSuccess" id="erpr2" style="display: none;margin-left: -139px;"><i class="fa fa-check label-danger"></i> Password Tidak Sesuai </label>

						</div>

						<label class="btn_1 rounded" for="inputError"  id="scpr2" style="display: none;margin-left: -139px;"><i class="fa fa-times label-success"></i>Password Sesuai</label>
...
<script>
  function cek_pass(val) {

    var pass_sebelum = $('#myInput').val();
