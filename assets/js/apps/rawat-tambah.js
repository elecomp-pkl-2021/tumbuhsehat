        ...
        if (arrId4Sisi.indexOf(data[i].id) > -1){
         //   console.log('arrId4Sisi', arrId4Sisi);
            var svg =   '<g id="'+data[i].id+'" class="'+data[i].id+'" transform="translate('+data[i].transform1+','+data[i].transform2+')">'+
                        ...
                        '<polygon points="20,0  20,0    20,20   15,10" fill="'+data[i].data.RD+'" stroke="navy" stroke-width="0.5" id="RD" opacity="1" onclick="clickSvg(this);"></polygon>' +
                        ...
                        '<polygon points="3,0   3,0     3,19    3,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        '<polygon points="5,0   5,0     5,19    5,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        '<polygon points="7,0   7,10     7,19    7,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        '<polygon points="9,0   9,0     9,19    9,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        '<polygon points="11,0   11,0     11,19    11,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        '<polygon points="13,0   13,0     13,19    13,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        '<polygon points="15,0   15,0     15,19    15,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        '<polygon points="17,0   17,0     17,19    17,20" fill="'+data[i].data.AB+'" stroke="'+data[i].data.AB+'" stroke-width="0.5" id="AB'+data[i].id+'" opacity="'+data[i].data.AB_opacity+'" onclick="clickSvg(this);" class="ausente59 AB'+data[i].id+'"></polygon>'+
                        ...
                        '<polygon points="0,30   0,35     0,20    0,20" fill="'+data[i].data.BD+'" stroke="'+data[i].data.BD+'" stroke-width="2" id="BD'+data[i].id+'" opacity="'+data[i].data.BD_opacity+'" onclick="clickSvg(this);" class="ausente63 BD'+data[i].id+'"></polygon>'+
                        '<polygon points="20,35   20,35     20,20    20,20" fill="'+data[i].data.BE+'" stroke="'+data[i].data.BE+'" stroke-width="2" id="BE'+data[i].id+'" opacity="'+data[i].data.BE_opacity+'" onclick="clickSvg(this);" class="ausente64 BE'+data[i].id+'"></polygon>'+

                        '<polygon points="3,0   3,0     3,19    3,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<polygon points="5,0   5,0     5,19    5,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<polygon points="7,0   7,10     7,19    7,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<polygon points="9,0   9,0     9,19    9,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<polygon points="11,0   11,0     11,19    11,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<polygon points="13,0   13,0     13,19    13,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<polygon points="15,0   15,0     15,19    15,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<polygon points="17,0   17,0     17,19    17,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
            ...
            var svg =  ' <g id="'+data[i].id+'" class="'+data[i].id+'" transform="translate('+data[i].transform1+','+data[i].transform2+')">' +
                        ...
                        '<polygon points="15,5  20,0    20,20   15,15" fill="'+data[i].data.RD+'" stroke="navy" stroke-width="0.5" id="RD" opacity="1" onclick="clickSvg(this);"></polygon>' +
                        ...
                        '<polygon points="25,35   25,35     0,35    0,35" fill="'+data[i].data.BA+'" stroke="'+data[i].data.BA+'" stroke-width="2" id="BA'+data[i].id+'" opacity="'+data[i].data.BA_opacity+'" onclick="clickSvg(this);" class="ausente60 BA'+data[i].id+'"></polygon>'+
                        '<polygon points="25,35   25,35     0,35    0,35" fill="'+data[i].data.BB+'" stroke="'+data[i].data.BB+'" stroke-width="2" id="BB'+data[i].id+'" opacity="'+data[i].data.BB_opacity+'" onclick="clickSvg(this);" class="ausente61 BB'+data[i].id+'"></polygon>'+
                        '<polygon points="25,35   25,35     0,35    0,35" fill="'+data[i].data.BC+'" stroke="'+data[i].data.BC+'" stroke-width="2" id="BC'+data[i].id+'" opacity="'+data[i].opacity+'" onclick="clickSvg(this);" class="ausente62 BC'+data[i].id+'"></polygon>'+
                        '<polygon points="0,30   0,35     0,20    0,20" fill="'+data[i].data.BD+'" stroke="'+data[i].data.BD+'" stroke-width="2" id="BD'+data[i].id+'" opacity="'+data[i].opacity+'" onclick="clickSvg(this);" class="ausente63 BD'+data[i].id+'"></polygon>'+
                        '<polygon points="20,35   20,35     20,20    20,20" fill="'+data[i].data.BE+'" stroke="'+data[i].data.BE+'" stroke-width="2" id="BE'+data[i].id+'" opacity="'+data[i].opacity+'" onclick="clickSvg(this);" class="ausente64 BE'+data[i].id+'"></polygon>'+
                        ...
                        '<polygon points="17,0   17,0     17,19    17,20" fill="'+data[i].data.BF+'" stroke="'+data[i].data.BF+'" stroke-width="0.5" id="BF'+data[i].id+'" opacity="'+data[i].data.BF_opacity+'" onclick="clickSvg(this);" class="ausente65 BF'+data[i].id+'"></polygon>'+
                        '<text x="6" y="30" stroke="navy" fill="navy" stroke-width="0.1" style="font-size: 6pt;font-weight:normal">'+data[i].title+'</text>' +
                        // '<text x="6" y="37" id="appendket1'+data[i].id+'" class="appendket1'+data[i].id+'" stroke="navy" fill="navy" stroke-width="0.1" style="font-size: 6pt;font-weight:normal"></text>' +
                        // '<text x="6" y="43" id="appendket2'+data[i].id+'" class="appendket2'+data[i].id+'" stroke="navy" fill="navy" stroke-width="0.1" style="font-size: 6pt;font-weight:normal"></text>' +
                        // '<text x="6" y="30" id="appendket3'+data[i].id+'" class="appendket3'+data[i].id+'" stroke="navy" fill="navy" stroke-width="0.1" style="font-size: 6pt;font-weight:normal"></text>' +
                    '</g>';
...
function getPosition(event){
    ...
    if (arraySambung.length < 1) {
        ...
        var diferencia = Math.abs((parseInt(arraySambung[1].kuadran) - parseInt(arraySambung[1].father)));
                ...
                $("#"+idSvg+"").click(function(){
                    ...
                    if (arraySambung.length < 1) {
                      ...
                      //  $(this).parent().children('.ausente').css('stroke', 'red');
                        ...
                        var diferencia = Math.abs((parseInt(arraySambung[1].diente) - parseInt(arraySambung[1].father)));
                        console.log('diferencia', diferencia);
                        ...
                        $(this).parent().append('<g transform="translate(0,120)" style="z-index: 9999; height: 5px; width:' + width + 'px;" id="sambung" class="click-red" style="background-color: red !important;"><text x="6" y="40" stroke="navy" fill="navy" stroke-width="0.1" style="font-size: 6pt;font-weight:normal">sambung</text></g>');
...
function saveHeaderRawat(button) {
    ...
    $.ajax({
        ...
        data: $('#formRawatTambah').serialize() + "&odontogram=" + JSON.stringify(allDentalAfter),
        ...
        success: function(json) {
            ...
            swal({	
                title : "Berhasil!",
                html: "Perawatan Pasien atas nama "+nama_lengkap+" telah selesai. Seluruh data telah terekam dalam Summary Rekam Medis pasien terkait",
                type: "success",
...
function load_odontogram(){
    ...
    $('#kota').html("<img style='display: block; margin: 0 auto; text-align: center; ' src='"+base_url+"assets/img/loader-dark.gif'>");

    $.get(""+base_url+"Doctor/create_load", {tgl_awal:tgl_awal, id_pasien:id_pasien}, function(data){
        $('#kota').html(data);
    });
}
...
function save_temp(){
    ...
    $.ajax({
        ...
        data: $('#formRawatTambah').serialize() + "&odontogram=" + JSON.stringify(allDental),
...
function getCheckDataFromServer(){
    $.ajax({
        'async': false,
        url : link2+"Doctor/ajax_check_id/",
        type: "GET",
        dataType: "JSON",
        success: function(data) {  
            dataCheckData = data.sort(function (a, b) {   
                return a.id_rekam_medis - b.id_rekam_medis || b.id_pasien - a.id_pasien || b.tgl_pemeriksaan - a.tgl_pemeriksaan;
            }); 
        }
    })            
}
...
function getcheckjumlah(id_pemeriksaan2, id_pasien2, date){
    ...
    let datacheckdata = dataCheckData.filter(v => {
        return v.id_rekam_medis == id_pemeriksaan2 && v.id_pasien == id_pasien2 && v.tgl_pemeriksaan == date;
    })
